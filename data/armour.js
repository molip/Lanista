Data.Armour.Types = { //						name				cost	image							description,			sites (species, body part, count)		defence
	'helmet':			new Data.Armour.Type(	'Helmet',			50,		'images/items/helmet.png',		"It's a Helmet",		[ new Data.Site('human', 'head', 1) ],	{ blade:10, pierce:10, impact: 10, crush: 10 }	),
	...
	'chestplate':		new Data.Armour.Type(	'Chestplate',		53,		'images/items/chestplate.png',	"It's a Chestplate",	[ new Data.Site('human', 'body', 1)],	{ blade:10, pierce:10, impact: 10, crush: 10 }	),
